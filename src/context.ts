 ...
 * re-read from the process environment for each request.
 *
 * Usage:
 ...
 *   import { context } from "attune-sdk";
 *   import { listPacks } from "attune-sdk/api_client";
 *
...
export type SensorTokenSource = "none" | "env";
...
export interface SensorContext {
  ...
  readonly packRef: string;
  /** Explicit runtime config from ATTUNE_SENSOR_CONFIG_* environment variables. */
  readonly config: Record<string, string>;
  /**
   * Returns the current sensor API token from the process environment.
   */
